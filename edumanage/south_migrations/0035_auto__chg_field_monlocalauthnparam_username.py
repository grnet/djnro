...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonLocalAuthnParam.username'
        db.alter_column('edumanage_monlocalauthnparam', 'username', self.gf('django.db.models.fields.CharField')(max_length=36))
    
    
    def backwards(self, orm):
        
        # Changing field 'MonLocalAuthnParam.username'
        db.alter_column('edumanage_monlocalauthnparam', 'username', self.gf('django.db.models.fields.CharField')(max_length=24))
