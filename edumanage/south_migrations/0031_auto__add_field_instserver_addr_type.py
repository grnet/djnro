...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstServer.addr_type'
        db.add_column('edumanage_instserver', 'addr_type', self.gf('django.db.models.fields.PositiveIntegerField')(default=2, max_length=2), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InstServer.addr_type'
        db.delete_column('edumanage_instserver', 'addr_type')
    ...
    models = {
        ...
        'edumanage.instserver': {
            ...
            'addr_type': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '2'}),
            ...
            'proto': ('django.db.models.fields.CharField', [], {'default': '2', 'max_length': '12'}),
