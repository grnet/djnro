...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Name_i18n.object_id'
        db.add_column('edumanage_name_i18n', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Name_i18n.content_type'
        db.add_column('edumanage_name_i18n', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Name_i18n.object_id'
        db.delete_column('edumanage_name_i18n', 'object_id')

        # Deleting field 'Name_i18n.content_type'
        db.delete_column('edumanage_name_i18n', 'content_type_id')
