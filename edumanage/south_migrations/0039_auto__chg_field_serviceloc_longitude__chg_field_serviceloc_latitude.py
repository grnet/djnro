...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceLoc.longitude'
        db.alter_column('edumanage_serviceloc', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=8))

        # Changing field 'ServiceLoc.latitude'
        db.alter_column('edumanage_serviceloc', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=8))
    
    
    def backwards(self, orm):
        
        # Changing field 'ServiceLoc.longitude'
        db.alter_column('edumanage_serviceloc', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=7))

        # Changing field 'ServiceLoc.latitude'
        db.alter_column('edumanage_serviceloc', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=7))
