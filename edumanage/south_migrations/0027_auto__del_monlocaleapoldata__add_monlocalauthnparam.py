...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MonLocalAuthnParam'
        db.create_table('edumanage_monlocalauthnparam', (
        ...
        db.send_create_signal('edumanage', ['MonLocalAuthnParam'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MonLocalAuthnParam'
        db.delete_table('edumanage_monlocalauthnparam')
