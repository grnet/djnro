...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('edumanage_monproxybackclient', 'secret', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'InstServer.secret'
        db.alter_column('edumanage_instserver', 'secret', self.gf('django.db.models.fields.CharField')(max_length=80))
    
    
    def backwards(self, orm):
        
        # Changing field 'MonProxybackClient.secret'
        db.alter_column('edumanage_monproxybackclient', 'secret', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'InstServer.secret'
        db.alter_column('edumanage_instserver', 'secret', self.gf('django.db.models.fields.CharField')(max_length=16))
