...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceLoc.address_city'
        db.alter_column('edumanage_serviceloc', 'address_city', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'ServiceLoc.address_street'
        db.alter_column('edumanage_serviceloc', 'address_street', self.gf('django.db.models.fields.CharField')(max_length=96))
    
    
    def backwards(self, orm):
        
        # Changing field 'ServiceLoc.address_city'
        db.alter_column('edumanage_serviceloc', 'address_city', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'ServiceLoc.address_street'
        db.alter_column('edumanage_serviceloc', 'address_street', self.gf('django.db.models.fields.CharField')(max_length=32))
