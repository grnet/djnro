...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field instid on 'InstServer'
        m2m_table_name = db.shorten_name('edumanage_instserver_instid')
    ...
    def backwards(self, orm):
        # Removing M2M table for field instid on 'InstServer'
        db.delete_table(db.shorten_name('edumanage_instserver_instid'))
    ...
    models = {
        ...
        'edumanage.instserver': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instid': ('django.db.models.fields.related.ManyToManyField', [], {'default': "'none'", 'related_name': "'servers'", 'symmetrical': 'False', 'to': "orm['edumanage.Institution']"}),
            'instid_m2m': ('django.db.models.fields.related.ManyToManyField', [], {'default': "'none'", 'related_name': "'servers_tmp'", 'symmetrical': 'False', 'to': "orm['edumanage.Institution']"}),
