...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Contact.name' to match new field type.
        db.rename_column('edumanage_contact', 'contact_firstname', 'contact_name')
        # Changing field 'Contact.name'
        db.alter_column('edumanage_contact', 'contact_name', self.gf('django.db.models.fields.CharField')(max_length=255, db_column='contact_name'))
    
    
    def backwards(self, orm):
        
        # Renaming column for 'Contact.name' to match new field type.
        db.rename_column('edumanage_contact', 'contact_name', 'contact_firstname')
        # Changing field 'Contact.name'
        db.alter_column('edumanage_contact', 'contact_firstname', self.gf('django.db.models.fields.CharField')(max_length=80, db_column='contact_firstname'))
