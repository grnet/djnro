...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstitutionDetails.oper_name'
        db.alter_column('edumanage_institutiondetails', 'oper_name', self.gf('django.db.models.fields.CharField')(max_length=24, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'InstitutionDetails.oper_name'
        db.alter_column('edumanage_institutiondetails', 'oper_name', self.gf('django.db.models.fields.CharField')(max_length=24))
