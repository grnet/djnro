...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InstServer.instid'
        db.delete_column('edumanage_instserver', 'instid_id')


    def backwards(self, orm):
        # Adding field 'InstServer.instid'
        db.add_column('edumanage_instserver', 'instid',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edumanage.Institution'], null=True),
                      keep_default=False)
