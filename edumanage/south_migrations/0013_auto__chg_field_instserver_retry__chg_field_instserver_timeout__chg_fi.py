...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstServer.retry'
        db.alter_column('edumanage_instserver', 'retry', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2, null=True, blank=True))

        # Changing field 'InstServer.timeout'
        db.alter_column('edumanage_instserver', 'timeout', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2, null=True, blank=True))

        # Changing field 'InstServer.acct_port'
        db.alter_column('edumanage_instserver', 'acct_port', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=5, null=True, blank=True))

        # Changing field 'InstServer.port'
        db.alter_column('edumanage_instserver', 'port', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=5, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'InstServer.retry'
        db.alter_column('edumanage_instserver', 'retry', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2))

        # Changing field 'InstServer.timeout'
        db.alter_column('edumanage_instserver', 'timeout', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2))

        # Changing field 'InstServer.acct_port'
        db.alter_column('edumanage_instserver', 'acct_port', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=5))

        # Changing field 'InstServer.port'
        db.alter_column('edumanage_instserver', 'port', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=5))
