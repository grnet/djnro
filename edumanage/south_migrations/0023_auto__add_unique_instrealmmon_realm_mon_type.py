...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'InstRealmMon', fields ['realm', 'mon_type']
        db.create_unique('edumanage_instrealmmon', ['realm_id', 'mon_type'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'InstRealmMon', fields ['realm', 'mon_type']
        db.delete_unique('edumanage_instrealmmon', ['realm_id', 'mon_type'])
