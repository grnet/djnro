...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InstRealm.priority'
        db.delete_column('edumanage_instrealm', 'priority')

        # Deleting field 'InstRealm.realmexpr'
        db.delete_column('edumanage_instrealm', 'realmexpr')

        # Adding field 'InstRealm.realm'
        db.add_column('edumanage_instrealm', 'realm', self.gf('django.db.models.fields.CharField')(default='', max_length=160), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'InstRealm.priority'
        db.add_column('edumanage_instrealm', 'priority', self.gf('django.db.models.fields.PositiveIntegerField')(default='', max_length=3), keep_default=False)

        # Adding field 'InstRealm.realmexpr'
        db.add_column('edumanage_instrealm', 'realmexpr', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Deleting field 'InstRealm.realm'
        db.delete_column('edumanage_instrealm', 'realm')
