...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CatEnrollment'
        db.create_table('edumanage_catenrollment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cat_inst_id', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10)),
            ('inst', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edumanage.Institution'])),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('cat_instance', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('ts', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('edumanage', ['CatEnrollment'])

        # Adding unique constraint on 'CatEnrollment', fields ['inst', 'cat_instance']
        db.create_unique('edumanage_catenrollment', ['inst_id', 'cat_instance'])


    def backwards(self, orm):
        # Removing unique constraint on 'CatEnrollment', fields ['inst', 'cat_instance']
        db.delete_unique('edumanage_catenrollment', ['inst_id', 'cat_instance'])

        # Deleting model 'CatEnrollment'
        db.delete_table('edumanage_catenrollment')
