...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonProxybackClient.name'
        db.alter_column('edumanage_monproxybackclient', 'name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'MonProxybackClient.name'
        db.alter_column('edumanage_monproxybackclient', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))
