...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('edumanage_institution', 'ertype', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=1, db_column='type'), keep_default=False)

        # Deleting field 'InstitutionDetails.ertype'
        db.delete_column('edumanage_institutiondetails', 'type')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'InstitutionDetails.ertype'
        db.add_column('edumanage_institutiondetails', 'ertype', self.gf('django.db.models.fields.PositiveIntegerField')(default=3, max_length=1, db_column='type'), keep_default=False)
