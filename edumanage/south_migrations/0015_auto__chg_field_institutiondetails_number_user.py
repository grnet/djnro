...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstitutionDetails.number_user'
        db.alter_column('edumanage_institutiondetails', 'number_user', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=6, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'InstitutionDetails.number_user'
        db.alter_column('edumanage_institutiondetails', 'number_user', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=6))
