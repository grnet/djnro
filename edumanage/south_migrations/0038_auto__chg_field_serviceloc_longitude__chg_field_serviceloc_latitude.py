...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ServiceLoc.longitude'
        db.alter_column('edumanage_serviceloc', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=6))

        # Changing field 'ServiceLoc.latitude'
        db.alter_column('edumanage_serviceloc', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=6))
