...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Realm.country'
        db.alter_column('edumanage_realm', 'country', self.gf('django.db.models.fields.CharField')(max_length=5))
    
    
    def backwards(self, orm):
        
        # Changing field 'Realm.country'
        db.alter_column('edumanage_realm', 'country', self.gf('django.db.models.fields.CharField')(max_length=2))
