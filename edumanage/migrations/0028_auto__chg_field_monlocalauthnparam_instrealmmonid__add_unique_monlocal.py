...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonLocalAuthnParam.instrealmmonid'
        db.alter_column('edumanage_monlocalauthnparam', 'instrealmmonid_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['edumanage.InstRealmMon'], unique=True))

        # Adding unique constraint on 'MonLocalAuthnParam', fields ['instrealmmonid']
        db.create_unique('edumanage_monlocalauthnparam', ['instrealmmonid_id'])
    
    
    def backwards(self, orm):
        
        # Changing field 'MonLocalAuthnParam.instrealmmonid'
        db.alter_column('edumanage_monlocalauthnparam', 'instrealmmonid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edumanage.InstRealmMon']))

        # Removing unique constraint on 'MonLocalAuthnParam', fields ['instrealmmonid']
        db.delete_unique('edumanage_monlocalauthnparam', ['instrealmmonid_id'])
