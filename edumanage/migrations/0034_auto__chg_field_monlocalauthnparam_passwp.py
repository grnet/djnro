...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonLocalAuthnParam.passwp'
        db.alter_column('edumanage_monlocalauthnparam', 'pass', self.gf('django.db.models.fields.CharField')(max_length=80, db_column='pass'))
    
    
    def backwards(self, orm):
        
        # Changing field 'MonLocalAuthnParam.passwp'
        db.alter_column('edumanage_monlocalauthnparam', 'pass', self.gf('django.db.models.fields.CharField')(max_length=24, db_column='pass'))
