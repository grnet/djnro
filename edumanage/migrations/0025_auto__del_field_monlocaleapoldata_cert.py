...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MonLocalEAPOLData.cert'
        db.delete_column('edumanage_monlocaleapoldata', 'cert')
    
    
    def backwards(self, orm):
        
        # Adding field 'MonLocalEAPOLData.cert'
        db.add_column('edumanage_monlocaleapoldata', 'cert', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)
