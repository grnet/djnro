...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MonLocalEAPOLData.exp_response'
        db.delete_column('edumanage_monlocaleapoldata', 'exp_response')
    
    
    def backwards(self, orm):
        
        # Adding field 'MonLocalEAPOLData.exp_response'
        db.add_column('edumanage_monlocaleapoldata', 'exp_response', self.gf('django.db.models.fields.CharField')(default='', max_length=6), keep_default=False)
