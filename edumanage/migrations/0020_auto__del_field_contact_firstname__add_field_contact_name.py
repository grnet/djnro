...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('edumanage_contact', 'name', self.gf('django.db.models.fields.CharField')(default=' ', max_length=80, db_column='contact_firstname'), keep_default=False)
    ...
    models = {
        ...
        'edumanage.contact': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80', 'db_column': "'contact_firstname'"}),
