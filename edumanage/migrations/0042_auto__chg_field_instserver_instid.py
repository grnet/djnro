...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstServer.instid'
        db.alter_column('edumanage_instserver', 'instid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edumanage.Institution'], null=True))

    def backwards(self, orm):

        # Changing field 'InstServer.instid'
        db.alter_column('edumanage_instserver', 'instid_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['edumanage.Institution']))
