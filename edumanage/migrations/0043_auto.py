...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field instid_m2m on 'InstServer'
    ...
    def backwards(self, orm):
        # Removing M2M table for field instid_m2m on 'InstServer'
        db.delete_table(db.shorten_name('edumanage_instserver_instid_m2m'))
    ...
    models = {
        ...
        'edumanage.instserver': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['edumanage.Institution']", 'null': 'True'}),
            'instid_m2m': ('django.db.models.fields.related.ManyToManyField', [], {'default': "'none'", 'related_name': "'servers'", 'symmetrical': 'False', 'to': "orm['edumanage.Institution']"}),
